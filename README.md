...
![Goldlabel](https://goldlabel.pro/png/3rdParty/next_og.png)
...
Goldlabel is optimized for [Vercel](https://vercel.com), but can be deployed to any static-friendly hosting platform.
